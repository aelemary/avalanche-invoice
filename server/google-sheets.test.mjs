...
test('adds the total and payment status without overwriting calculated columns', () => {
    const invoice = { issuedDate: '2026-09-06', dueDate: '2026-09-20', invoiceNumber: 'I-060926-ABCDEF12', subtotal: 100, total: 120, paid: true };
